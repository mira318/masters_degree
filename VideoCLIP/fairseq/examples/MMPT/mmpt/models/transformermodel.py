...
from transformers.models.bert.modeling_bert import BertPreTrainedModel, BertModel, BertEncoder, BertPredictionHeadTransform
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if getattr(self.config, "gradient_checkpointing", False):
                ...
                layer_outputs = layer_module(
                    ...
                    encoder_hidden_states,
                    encoder_attention_mask,
                    None, # it is for the new argument past_key_value
                    output_attentions,
                )
