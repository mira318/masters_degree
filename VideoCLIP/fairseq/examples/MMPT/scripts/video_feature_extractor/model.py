...
def get_model(args):
    ...
    if args.type == '2d':
        ...
        ###############################################################################
        model = S3D('F:\\IChuviliaeva\\masters_degree\\VideoCLIP\\fairseq\\examples\\MMPT\\pretrained_models\\s3d_dict.npy', 512)
        model.load_state_dict(th.load('F:\\IChuviliaeva\\masters_degree\\VideoCLIP\\fairseq\\examples\\MMPT\\pretrained_models\\s3d_howto100m.pth'))
        ###############################################################################
